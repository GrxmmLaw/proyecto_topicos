...
K_SIZE = 31
HLL_ERROR_RATE = 0.01
OUTPUT_DIR = "hll_sim_catalog"  

TAREAS = [
    ("sim_catalogs/datasets_distintos", "distintos.sketch"),
    ("sim_catalogs/datasets_similares", "similares.sketch"),
    ("sim_catalogs/datasets_medios",    "medios.sketch")
]
...
def main():
    ...
    for carpeta_origen, nombre_archivo in TAREAS:
